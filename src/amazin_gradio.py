...
def reset_sys_instruction(instruction):
    default_inst = "Use the following pieces of context to answer the question at the end. Generate the answer based " \
        ...
        with gr.Column(scale=0.5, variant='panel'):
            ...
            with gr.Row(equal_height=True):
                ...
                with gr.Column(scale=0.5, variant='compact'):
                    ...
                    vector_index_msg_out = gr.Textbox(show_label=False, lines=1, scale=1,
        ...
        with gr.Column(scale=0.5, variant='panel'):
            ...
            with gr.Row(equal_height=True):
                with gr.Column(scale=0.5):
                    llm = gr.Dropdown(choices=["Llamav2-7B-Chat", "Falcon-7B-Instruct"], value="Llamav2-7B-Chat",
            ...
            model_load_btn.click(load_models, [hf_token, embedding_model, llm], load_success_msg,
